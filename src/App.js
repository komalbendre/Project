...
import Settings from './pages/Settings'; // Make sure this import is correct
  ...
  return (
    <ThemeProvider>
      <div style={{ minHeight: "100vh", background: "var(--bg-secondary, #f8fafc)" }}>
        ...
        {/* Company sidebar for company routes */}
        ...
        {/* Main content with sidebar margin for company routes */}
        <div style={{
          ...
          <Routes>
            ...
            <Route path="/company/messages" element={
              <ProtectedRoute>
                <div style={{ padding: '2rem' }}>Messages</div>
              </ProtectedRoute>
            } />
            <Route path="/company/candidates" element={
              <ProtectedRoute>
                <div style={{ padding: '2rem' }}>Candidates</div>
              </ProtectedRoute>
            } />
            ...
            <Route path="/company/billing" element={
              <ProtectedRoute>
                <div style={{ padding: '2rem' }}>Billing</div>
              </ProtectedRoute>
            } />
          </Routes>
        </div>
